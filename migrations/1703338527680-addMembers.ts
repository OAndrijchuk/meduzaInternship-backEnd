...
export class AddMembers1703338527680 implements MigrationInterface {
    name = 'AddMembers1703338527680'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "members" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userIdId" integer, "companyIdId" integer, CONSTRAINT "PK_28b53062261b996d9c99fa12404" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "company_invite" ("id" SERIAL NOT NULL, "description" character varying NOT NULL DEFAULT '', "status" "public"."company_invite_status_enum" NOT NULL DEFAULT 'pending', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "companyId" integer, "userId" integer, CONSTRAINT "PK_7c86e1788d1bb358b229beb9c18" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "members" ADD CONSTRAINT "FK_22106b6bdb9edb5cca6f54975d0" FOREIGN KEY ("userIdId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "members" ADD CONSTRAINT "FK_bb9caf021d093d4781245637cdb" FOREIGN KEY ("companyIdId") REFERENCES "company"("companyId") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "members" DROP CONSTRAINT "FK_bb9caf021d093d4781245637cdb"`);
        await queryRunner.query(`ALTER TABLE "members" DROP CONSTRAINT "FK_22106b6bdb9edb5cca6f54975d0"`);
